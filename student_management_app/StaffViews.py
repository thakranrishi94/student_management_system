...
def view_all_staff(request):
    ...
    return render(request, "staff_template/view_all_staff_template.html", context)
...
def view_staff_dashboard(request, staff_id):
    ...
    return render(request, "staff_template/view_staff_dashboard_template.html", context)
